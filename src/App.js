  ...
  return (
...

    {
      ...
      (
            ...
            <Container bgSize={'100% 100%'} bgImage={'https://img.freepik.com/free-vector/colorful-3d-background_23-2148484152.jpg?size=626&ext=jpg&ga=GA1.1.386372595.1697846400&semt=ais'} h={'100vh'} padding={'2'} > 
            <VStack h={'full'}>
              ...
              <HStack >
                <Input
                  ...
                  placeholder="Enter a Message..." colorScheme="black" bg={'black.100'}></Input>
                  <Button colorScheme="green" onClick={()=>setVisible(!visible)}>:)</Button>
                  {visible && 
